...
def print_panel():
    ...
    log.info("╔═════════════╦═════════════╦═════════════╦═════════════╦═════════════╦═════════════╦═════════════╦═════════════╦═════════════╗")
    log.info("║   Licence   ║    Server   ║    Status   ║    Total    ║ Average Use ║  Username   ║ In Use All  ║ In Use NeSI ║  Token Use  ║     Soak    ║")
    #log.info("╠═════════════╬═════════════╬═════════════╬═════════════╬═════════════╬═════════════╬═════════════╬═════════════╬═════════════╣")
        ...
        if value["enabled"]:
            ...
            if value["real_usage_nesi"]:
                ...
                for user, user_value in value["users_nesi"].items():  
                    ...
                    log.info("║             "*5 + "║" + fit_2_col(user) + "║" + fit_2_col(user_value["count"]) + "║" + fit_2_col(", ".join(user_value["sockets"]),27) + "║")
